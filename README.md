...
apk add bash libc6-compat make gettext texinfo patch git curl
...
```shell
apt install xz-utils make gettext texinfo patch git curl
...
```shell
yum install xz make gettext texinfo patch git curl
