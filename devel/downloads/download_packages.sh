...
function main() {
	...
	download 'tzdata' "${TZDATA_PACKAGE_URL}" "${TZDATA_PACKAGE_SHA256SUM}" "${TZDATA_PACKAGE_NAME}"
	download 'tzcode' "${TZCODE_PACKAGE_URL}" "${TZCODE_PACKAGE_SHA256SUM}" "${TZCODE_PACKAGE_NAME}"
