...
CURL_PACKAGE_URL='https://curl.se/download/curl-8.15.0.tar.gz'
CURL_PACKAGE_SHA256SUM='d85cfc79dc505ff800cb1d321a320183035011fa08cb301356425d86be8fc53c'
CURL_PACKAGE_NAME='curl-8.15.0.tar.gz'
CURL_PACKAGE_EXTRACTED_DIR='curl-8.15.0'
...
SQLITE_PACKAGE_URL='https://sqlite.org/2025/sqlite-autoconf-3500300.tar.gz'
SQLITE_PACKAGE_SHA256SUM='ec5496cdffbc2a4adb59317fd2bf0e582bf0e6acd8f4aae7e97bc723ddba7233'
SQLITE_PACKAGE_NAME='sqlite-autoconf-3500300.tar.gz'
SQLITE_PACKAGE_EXTRACTED_DIR='sqlite-autoconf-3500300'

PYTHON_PACKAGE_URL='https://github.com/python/cpython/archive/refs/tags/v3.13.6.tar.gz'
PYTHON_PACKAGE_SHA256SUM='d0b1657a7e4365b551361cec47f5290dbe51eb9da3ee19d39b238bb8b1d72087'
PYTHON_PACKAGE_NAME='cpython-3.13.6.tar.gz'
PYTHON_PACKAGE_EXTRACTED_DIR='cpython-3.13.6'
...
GIT_PACKAGE_URL='https://mirrors.edge.kernel.org/pub/software/scm/git/git-2.50.1.tar.gz'
GIT_PACKAGE_SHA256SUM='522d1635f8b62b484b0ce24993818aad3cab8e11ebb57e196bda38a3140ea915'
GIT_PACKAGE_NAME='git-2.50.1.tar.gz'
GIT_PACKAGE_EXTRACTED_DIR='git-2.50.1'
...
NEOVIM_PACKAGE_URL="https://github.com/neovim/neovim/releases/download/v0.11.3/nvim-linux-${ARCH/aarch64/arm64}.tar.gz"
if [[ "${ARCH}" == 'x86_64' ]]; then
	NEOVIM_PACKAGE_SHA256SUM='02b808a3ee8fc30161e07fe3c3edfb24b28bd0295323ac5dbdd8ec7012cac67d'
else
	NEOVIM_PACKAGE_SHA256SUM='ed53af6b8125475003b8a44a2b73d39fa6cc38243ec39c31e2f85062c302ccaa'
fi
...
CMAKE_PACKAGE_URL="https://github.com/Kitware/CMake/releases/download/v4.1.0/cmake-4.1.0-linux-${ARCH}.tar.gz"
if [[ "${ARCH}" == 'x86_64' ]]; then
	CMAKE_PACKAGE_SHA256SUM='2637dab096e65c7d011ca0504fc0c563f8ffb531919754156ddec4b7a2f8584d'
elif [[ "${ARCH}" == 'aarch64' ]]; then
	CMAKE_PACKAGE_SHA256SUM='37493fc5d25727342977b19ae0a64df68537fa4317a5f30a65c5b13e6afaad6c'
fi
CMAKE_PACKAGE_NAME="cmake-4.1.0-linux-${ARCH}.tar.gz"
...
LIBXML2_PACKAGE_URL='https://github.com/GNOME/libxml2/archive/refs/tags/v2.14.5.tar.gz'
LIBXML2_PACKAGE_SHA256SUM='f52638e4d67135c49f676d1c8fcc4f9f35afb7ec9bfb4aee743e2e86d56e006b'
LIBXML2_PACKAGE_NAME='libxml2-2.14.5.tar.gz'
LIBXML2_PACKAGE_EXTRACTED_DIR='libxml2-2.14.5'
...
LLVM_PACKAGE_URL='https://github.com/llvm/llvm-project/releases/download/llvmorg-20.1.8/llvm-project-20.1.8.src.tar.xz'
LLVM_PACKAGE_SHA256SUM='6898f963c8e938981e6c4a302e83ec5beb4630147c7311183cf61069af16333d'
LLVM_PACKAGE_NAME='llvm-project-20.1.8.src.tar.xz'
LLVM_PACKAGE_EXTRACTED_DIR='llvm-project-20.1.8.src'
