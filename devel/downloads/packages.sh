...
OPENSSL_PACKAGE_URL='https://www.openssl.org/source/openssl-1.1.1s.tar.gz'
OPENSSL_PACKAGE_SHA256SUM='c5ac01e760ee6ff0dab61d6b2bbd30146724d063eb322180c6f18a6f74e4b6aa'
OPENSSL_PACKAGE_NAME='openssl-1.1.1s.tar.gz'
OPENSSL_PACKAGE_EXTRACTED_DIR='openssl-1.1.1s'
