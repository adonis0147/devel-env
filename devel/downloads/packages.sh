...
GIT_PACKAGE_URL='https://github.com/git/git/archive/refs/tags/v2.51.0.tar.gz'
GIT_PACKAGE_SHA256SUM='3524fc5fd81f16f80e1696a8281bd8ad831048b67848015d7b7382bf365ae685'
GIT_PACKAGE_NAME='git-2.51.0.tar.gz'
GIT_PACKAGE_EXTRACTED_DIR='git-2.51.0'
