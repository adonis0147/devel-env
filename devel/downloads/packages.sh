...
GIT_PACKAGE_URL='https://github.com/git/git/archive/refs/tags/v2.51.2.tar.gz'
GIT_PACKAGE_SHA256SUM='024e03605148682cf36fc7eade98405f4448e44532e1e65bd653c2ad2a59e0f7'
GIT_PACKAGE_NAME='git-2.51.2.tar.gz'
GIT_PACKAGE_EXTRACTED_DIR='git-2.51.2'
