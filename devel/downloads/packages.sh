...
RUST_PACKAGE_URL="https://static.rust-lang.org/dist/rust-1.93.1-${ARCH}-unknown-linux-gnu.tar.xz"
if [[ "${ARCH}" == 'x86_64' ]]; then
	RUST_PACKAGE_SHA256SUM='518872275a3648f735471d7add854d39171c5a6b17f423c4d7f931f52120c2af'
elif [[ "${ARCH}" == 'aarch64' ]]; then
	RUST_PACKAGE_SHA256SUM='701d55b62286bed013ceb2393ff7687d0953205605afaa15c62e2cd18024c32c'
fi
...
PYTHON_PACKAGE_URL='https://github.com/python/cpython/archive/refs/tags/v3.14.3.tar.gz'
PYTHON_PACKAGE_SHA256SUM='f229a232052ae318d2fc8eb0aca4a02d631e7e1a8790ef1f9b65e1632743a469'
...
CCACHE_PACKAGE_URL='https://github.com/ccache/ccache/releases/download/v4.12.3/ccache-4.12.3.tar.gz'
CCACHE_PACKAGE_SHA256SUM='d683d5964a395f00c1c812ea1d1d523179f1097cbff7e7e54e714fa3f99711b1'
CCACHE_PACKAGE_NAME='ccache-4.12.3.tar.gz'
CCACHE_PACKAGE_EXTRACTED_DIR='ccache-4.12.3'
...
LLVM_PACKAGE_URL='https://github.com/llvm/llvm-project/releases/download/llvmorg-22.1.0/llvm-project-22.1.0.src.tar.xz'
LLVM_PACKAGE_SHA256SUM='25d2e2adc4356d758405dd885fcfd6447bce82a90eb78b6b87ce0934bd077173'
LLVM_PACKAGE_NAME='llvm-project-22.1.0.src.tar.xz'
LLVM_PACKAGE_EXTRACTED_DIR='llvm-project-22.1.0.src'
