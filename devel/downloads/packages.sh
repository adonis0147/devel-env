...
CURL_PACKAGE_URL='https://curl.se/download/curl-8.17.0.tar.gz'
CURL_PACKAGE_SHA256SUM='e8e74cdeefe5fb78b3ae6e90cd542babf788fa9480029cfcee6fd9ced42b7910'
CURL_PACKAGE_NAME='curl-8.17.0.tar.gz'
CURL_PACKAGE_EXTRACTED_DIR='curl-8.17.0'
...
SQLITE_PACKAGE_NAME='sqlite-autoconf-3510100.tar.gz'
SQLITE_PACKAGE_EXTRACTED_DIR='sqlite-autoconf-3510100'
...
GIT_PACKAGE_URL='https://github.com/git/git/archive/refs/tags/v2.52.0.tar.gz'
GIT_PACKAGE_SHA256SUM='da8be57afb73a2370a5a891405b5e5624562f07a5c041f9e827e75320dc61114'
GIT_PACKAGE_NAME='git-2.52.0.tar.gz'
GIT_PACKAGE_EXTRACTED_DIR='git-2.52.0'
...
CMAKE_PACKAGE_URL="https://github.com/Kitware/CMake/releases/download/v4.2.1/cmake-4.2.1-linux-${ARCH}.tar.gz"
if [[ "${ARCH}" == 'x86_64' ]]; then
	CMAKE_PACKAGE_SHA256SUM='c059bff1e97a2b6b5b0c0872263627486345ad0ed083298cb21cff2eda883980'
elif [[ "${ARCH}" == 'aarch64' ]]; then
	CMAKE_PACKAGE_SHA256SUM='3e178207a2c42af4cd4883127f8800b6faf99f3f5187dccc68bfb2cc7808f5f7'
fi
CMAKE_PACKAGE_NAME="cmake-4.2.1-linux-${ARCH}.tar.gz"
...
LLVM_PACKAGE_URL='https://github.com/llvm/llvm-project/releases/download/llvmorg-21.1.7/llvm-project-21.1.7.src.tar.xz'
LLVM_PACKAGE_SHA256SUM='e5b65fd79c95c343bb584127114cb2d252306c1ada1e057899b6aacdd445899e'
LLVM_PACKAGE_NAME='llvm-project-21.1.7.src.tar.xz'
LLVM_PACKAGE_EXTRACTED_DIR='llvm-project-21.1.7.src'
