...
if [[ "${ARCH}" == 'x86_64' ]]; then
	NEOVIM_PACKAGE_SHA256SUM='31cf85945cb600d96cdf69f88bc68bec814acbff50863c5546adef3a1bcef260'
else
	NEOVIM_PACKAGE_SHA256SUM='f697d4e4582b6e4b5c3c26e76e06ce26efa08ba1768e03fd2733fcc422bb0490'
fi
...
CMAKE_PACKAGE_URL="https://github.com/Kitware/CMake/releases/download/v4.3.2/cmake-4.3.2-linux-${ARCH}.tar.gz"
if [[ "${ARCH}" == 'x86_64' ]]; then
	CMAKE_PACKAGE_SHA256SUM='791ae3604841ca03cb3889a3ad89165346e4b180ae3448efd4b0caa9ef46d245'
elif [[ "${ARCH}" == 'aarch64' ]]; then
	CMAKE_PACKAGE_SHA256SUM='377079ab739f5765176f427609d9a2015b756ea20d5cba908d279c3731a2f481'
fi
CMAKE_PACKAGE_NAME="cmake-4.3.2-linux-${ARCH}.tar.gz"
CMAKE_PACKAGE_EXTRACTED_DIR="cmake-4.3.2-linux-${ARCH}"
...
LLVM_PACKAGE_URL='https://github.com/llvm/llvm-project/releases/download/llvmorg-22.1.6/llvm-project-22.1.6.src.tar.xz'
LLVM_PACKAGE_SHA256SUM='6e0b376a1f6d9873e7dfb09ae6e04b9c7024400f01733fa4c29be69d5c138bc2'
LLVM_PACKAGE_NAME='llvm-project-22.1.6.src.tar.xz'
LLVM_PACKAGE_EXTRACTED_DIR='llvm-project-22.1.6.src'
