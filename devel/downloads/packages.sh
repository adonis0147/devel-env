...
AUTOMAKE_PACKAGE_URL='https://ftpmirror.gnu.org/automake/automake-1.18.tar.gz'
AUTOMAKE_PACKAGE_SHA256SUM='af6043a5d4b3beef0c48161f4a6936259321cd101a34c1ab0768328515626c8a'
AUTOMAKE_PACKAGE_NAME='automake-1.18.tar.gz'
AUTOMAKE_PACKAGE_EXTRACTED_DIR='automake-1.18'
...
LIBFFI_PACKAGE_URL='https://github.com/libffi/libffi/releases/download/v3.5.0/libffi-3.5.0.tar.gz'
LIBFFI_PACKAGE_SHA256SUM='8c72678628a5dd8782f08ad421d5a441e42c1c5c1b33e0bc211cbfcf1f3b3978'
LIBFFI_PACKAGE_NAME='libffi-3.5.0.tar.gz'
LIBFFI_PACKAGE_EXTRACTED_DIR='libffi-3.5.0'
...
CURL_PACKAGE_URL='https://curl.se/download/curl-8.14.0.tar.gz'
CURL_PACKAGE_SHA256SUM='5eba3ec2d898919a4b34cc89ace0068d9d09420b8643f265aebac59f8d126203'
CURL_PACKAGE_NAME='curl-8.14.0.tar.gz'
CURL_PACKAGE_EXTRACTED_DIR='curl-8.14.0'
...
SQLITE_PACKAGE_URL='https://sqlite.org/2025/sqlite-autoconf-3500000.tar.gz'
SQLITE_PACKAGE_SHA256SUM='3bc776a5f243897415f3b80fb74db3236501d45194c75c7f69012e4ec0128327'
SQLITE_PACKAGE_NAME='sqlite-autoconf-3500000.tar.gz'
SQLITE_PACKAGE_EXTRACTED_DIR='sqlite-autoconf-3500000'

PYTHON_PACKAGE_URL='https://github.com/python/cpython/archive/refs/tags/v3.13.4.tar.gz'
PYTHON_PACKAGE_SHA256SUM='77af19cd06d5748bd214d65fb7345d4efa84fa19573e708c8b1daddebaa0ba62'
PYTHON_PACKAGE_NAME='cpython-3.13.4.tar.gz'
PYTHON_PACKAGE_EXTRACTED_DIR='cpython-3.13.4'
...
LIBXML2_PACKAGE_URL='https://github.com/GNOME/libxml2/archive/refs/tags/v2.14.3.tar.gz'
LIBXML2_PACKAGE_SHA256SUM='e282bfeb750be5f4baf98195c6393f9b7beadc6bed4d85e7ca37a66f56394b5f'
LIBXML2_PACKAGE_NAME='libxml2-2.14.3.tar.gz'
LIBXML2_PACKAGE_EXTRACTED_DIR='libxml2-2.14.3'
...
LLVM_PACKAGE_URL='https://github.com/llvm/llvm-project/releases/download/llvmorg-20.1.6/llvm-project-20.1.6.src.tar.xz'
LLVM_PACKAGE_SHA256SUM='5c70549d524284c184fe9fbff862c3d2d7a61b787570611b5a30e5cc345f145e'
LLVM_PACKAGE_NAME='llvm-project-20.1.6.src.tar.xz'
LLVM_PACKAGE_EXTRACTED_DIR='llvm-project-20.1.6.src'
