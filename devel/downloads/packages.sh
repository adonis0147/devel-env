...
LLVM_PACKAGE_URL='https://github.com/llvm/llvm-project/releases/download/llvmorg-18.1.6/llvm-project-18.1.6.src.tar.xz'
LLVM_PACKAGE_SHA256SUM='bd4b4cb6374bcd5fc5a3ba60cb80425d29da34f316b8821abc12c0db225cf6b4'
LLVM_PACKAGE_NAME='llvm-project-18.1.6.src.tar.xz'
LLVM_PACKAGE_EXTRACTED_DIR='llvm-project-18.1.6.src'
