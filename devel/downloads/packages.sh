...
CURL_PACKAGE_URL='https://curl.se/download/curl-8.3.0.tar.gz'
CURL_PACKAGE_SHA256SUM='d3a19aeea301085a56c32bc0f7d924a818a7893af253e41505d1e26d7db8e95a'
CURL_PACKAGE_NAME='curl-8.3.0.tar.gz'
CURL_PACKAGE_EXTRACTED_DIR='curl-8.3.0'
...
SQLITE_PACKAGE_URL='https://sqlite.org/2023/sqlite-autoconf-3430100.tar.gz'
SQLITE_PACKAGE_SHA256SUM='39116c94e76630f22d54cd82c3cea308565f1715f716d1b2527f1c9c969ba4d9'
SQLITE_PACKAGE_NAME='sqlite-autoconf-3430100.tar.gz'
SQLITE_PACKAGE_EXTRACTED_DIR='sqlite-autoconf-3430100'
...
CMAKE_PACKAGE_URL="https://github.com/Kitware/CMake/releases/download/v3.27.5/cmake-3.27.5-linux-${ARCH}.tar.gz"
if [[ "${ARCH}" == 'x86_64' ]]; then
	CMAKE_PACKAGE_SHA256SUM='138c68addae825b16ed78d792dafef5e0960194833f48bd77e7e0429c6bc081c'
elif [[ "${ARCH}" == 'aarch64' ]]; then
	CMAKE_PACKAGE_SHA256SUM='2ffaf176d0f93c332abaffbf3ce82fc8c90e49e0fcee8dc16338bcfbb150ead7'
fi
CMAKE_PACKAGE_NAME="cmake-3.27.5-linux-${ARCH}.tar.gz"
...
LLVM_PACKAGE_URL='https://github.com/llvm/llvm-project/releases/download/llvmorg-17.0.1/llvm-project-17.0.1.src.tar.xz'
LLVM_PACKAGE_SHA256SUM='b0e42aafc01ece2ca2b42e3526f54bebc4b1f1dc8de6e34f46a0446a13e882b9'
LLVM_PACKAGE_NAME='llvm-project-17.0.1.src.tar.xz'
LLVM_PACKAGE_EXTRACTED_DIR='llvm-project-17.0.1.src'
