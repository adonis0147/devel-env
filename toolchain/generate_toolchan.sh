...
declare -r BINUTILS_PACKAGE_URL='https://ftpmirror.gnu.org/binutils/binutils-2.45.1.tar.xz'
declare -r BINUTILS_MD5SUM='ff59f8dc1431edfa54a257851bea74e7'
...
declare -r GCC_PACKAGE_URL='https://gcc.gnu.org/pub/gcc/snapshots/16-20260201/gcc-16-20260201.tar.xz'
declare -r GCC_MD5SUM='99630376c78826e0ab999fbc866ee2b5'
