...
declare -r LINUX_PACKAGE_URL='https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.19.12.tar.xz'
declare -r LINUX_MD5SUM='1fba0c8f101a95ec82dbb864c5ef8be9'
...
declare -r GCC_PACKAGE_URL='https://gcc.gnu.org/pub/gcc/snapshots/LATEST-16/gcc-16-20260412.tar.xz'
declare -r GCC_MD5SUM='f8da649d93911b7eefe433b13abee1fd'
